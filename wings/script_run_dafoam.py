...
parser.add_argument(
    "-reference_area",
    help="The reference area for normalizing forces",
    type=float,
    default=1.0,
)
parser.add_argument(
...
# calculate the leList and teList
...
class Top(Multipoint):
    ...
    def configure(self):
        ...
        self.geometry.nom_addThicknessConstraints2D("thickcon", leList, teList, nSpan=20, nChord=20)
        ...
        self.add_constraint("scenario1.aero_post.CL", equals=lift_constraint, scaler=1.0)
